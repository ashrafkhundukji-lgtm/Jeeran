-- Adds campaigns.image_url to nearby_active_offers()'s return columns, so
-- the wallet-push code can populate imageModulesData for the top-ranked
-- offer without a second query. Another DROP+CREATE — CREATE OR REPLACE
